        ...
        GM_xmlhttpRequest({
          ...
          onload: function (response) {
            if (response.status == 200) {
              ...
              let rspXml = domParser.parseFromString(rspRaw, "application/xml");
      ...
      buildEpub: (info) => {
        if (info.XHRDone()) {
          ...
          //<ol><li><a href="Volume_0.xhtml">第一卷</a><ol><li><a href="Volume_0.xhtml#chapter_1">第一章</a></li></ol></li></ol>
          {
            //生成nav.xhtml
            let domParser = new DOMParser();
            let navXhtmlDoc = domParser.parseFromString(BuilderInfo.nav_xhtml.content, "application/xhtml+xml");
  ...
  if ('undefined' == typeof chapter_id || undefined === chapter_id) { }
    ...
    if ('0' == chapter_id) {//在章节名之后添加下载链接
      ...
      //添加全本下载链接
      {
        ...
        let aEleInput = document.createElement("input");
        ...
        let aEleSubEpub = document.createElement("a");
